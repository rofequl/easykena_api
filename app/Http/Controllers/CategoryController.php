...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $banner = $this->saveImagesWH($request, 'banner', 'upload/product/category/banner/', 800, 300);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (strlen($request->banner) > 200) {
            ...
            $category->banner = $this->saveImagesWH($request, 'banner', 'upload/product/category/banner/', 800, 300);
        }
