...
class SubSubcategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        return DB::table('sub_sub_categories')->join('categories', 'categories.id', '=', 'sub_sub_categories.category_id')
            ...
            ->select('categories.name as category', 'sub_categories.name as subcategory', 'sub_sub_categories.*')->get();
    }

    public function store(Request $request)
    {
        $this->validate($request, [
            'name' => 'required|string|max:50|unique:sub_sub_categories',
            'banner' => 'required',
        ...
        $banner = $this->saveImagesWH($request, 'banner', 'upload/product/subsubcategory/', 800, 300);
    ...
    {
        $this->validate($request, [
            'name' => 'required|string|max:50|unique:sub_sub_categories,name,' . $id,
            'banner' => 'required',
            'category_id' => 'required',
            'subcategory_id' => 'required',
        ]);
        ...
        if (strlen($request->banner) > 200) {
            ...
            $subcategory->banner = $this->saveImagesWH($request, 'banner', 'upload/product/subsubcategory/', 800, 300);
        }
